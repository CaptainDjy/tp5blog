<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"C:\phpStudy\PHPTutorial\WWW\tp5blog\public/../application/index\view\article\article.html";i:1525447801;s:39:"../application/index/common/header.html";i:1523430779;s:38:"../application/index/common/right.html";i:1525446086;s:37:"../application/index/common/foot.html";i:1521521025;}*/ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<link href="http://127.0.0.1/tp5blog/public/static/index/style/lady.css" type="text/css" rel="stylesheet" />
		<script type='text/javascript' src='http://127.0.0.1/tp5blog/public/static/index/style/ismobile.js'></script>
    </head>
...
<div class="position"><a href="<?php echo url('index/index'); ?>">主页</a> > <a href="<?php echo url('cate/index',array('cateid'=>$cates['id'])); ?>"><?php echo $cates['catename']; ?></a> >  </div>
        ...
        <div class="overall">
            <div class="left">
                ...
                <div class="substance">
              <img src="<?php if($articles['pic'] != ''): ?>http://127.0.0.1/tp5blog/public/<?php echo $articles['pic']; else: ?>http://127.0.0.1/tp5blog/public/static/index/images/error.png<?php endif; ?>" alt="" />
              <?php echo $articles['content']; ?>
                ...
                <ul>
                 <?php if(is_array($recres) || $recres instanceof \think\Collection || $recres instanceof \think\Paginator): $i = 0; $__LIST__ = $recres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                     <li><div class="tu"><a href='<?php echo url('article/index',array('arid'=>$vo['id'])); ?>' target="_blank"><img src="<?php if($vo['pic'] != ''): ?>http://127.0.0.1/tp5blog/public/<?php echo $vo['pic']; else: ?>http://127.0.0.1/tp5blog/public/static/index/images/error.png<?php endif; ?>" alt=""/></a></div><p><a href='<?php echo url('article/index',array('arid'=>$vo['id'])); ?>'><?php echo $vo['title']; ?></a></p></li>

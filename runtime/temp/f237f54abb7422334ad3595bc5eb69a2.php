<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"C:\phpStudy\PHPTutorial\WWW\tp5blog\public/../application/admin\view\admin\edit.html";i:1521717057;s:36:"../application/admin/common/top.html";i:1523431717;s:37:"../application/admin/common/left.html";i:1521689969;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>后台管理</title>
                    ...
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              ...
                              <p class="help-block col-sm-4 red">* 留空表示不修改密码</p>
                            </div>
                        </div>  
                        <div class="form-group">
